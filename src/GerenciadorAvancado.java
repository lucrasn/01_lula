...
public class GerenciadorAvancado { // A verdade é que eu queria que GerenciadorAvancado herdasse os coiso de GerenciadorGeral, mas não vou fazer isso porque não estudei muito sobre
